...
epicsEnvSet("PREFIX",        "USB1808:")
epicsEnvSet("PORT",          "USB1808_1")
epicsEnvSet("WDIG_POINTS",   "1048576")
epicsEnvSet("WGEN_POINTS",   "1048576")
epicsEnvSet("UNIQUE_ID",     "0215158E")
...
dbLoadTemplate("$(MEASCOMP)/db/USB1808.substitutions", "P=$(PREFIX),PORT=$(PORT),WDIG_POINTS=$(WDIG_POINTS),WGEN_POINTS=$(WGEN_POINTS)")
