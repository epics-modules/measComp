...
#define USB3100_DIO_DIR_IN  (0x01)
#define USB3100_DIO_DIR_OUT (0x00)

#define USB3100_UP_10_00V 0     // 0 - 10V
#define USB3100_BP_10_00V 1     // +/- 10V
#define USB3100_I_0_20_mA 2     // 0-20 mA

#define USB3100_SYNC_MASTER 0
#define USB3100_SYNC_SLAVE  1
