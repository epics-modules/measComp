...
void usbSetItem_USBTC_AI(hid_device *hid, uint8_t item, uint8_t subitem, float fValue)
{
  ...
  */
  ...
  switch (subitem) {
    case USB_TEMP_AI_FILTER_RATE:
    case USB_TEMP_AI_CH_0_TC:
    case USB_TEMP_AI_CH_1_TC:
    case USB_TEMP_AI_CH_0_GAIN:
    case USB_TEMP_AI_CH_1_GAIN:
    case USB_TEMP_AI_CH_0_VOLT_CONN:
    case USB_TEMP_AI_CH_1_VOLT_CONN:
...
void usbSetItem_USBTEMP_AI(hid_device *hid, uint8_t item, uint8_t subitem, float fValue)
{
  ...
  */
  ...
  switch (subitem) {
    case USB_TEMP_AI_SENSOR_TYPE:
    case USB_TEMP_AI_CONNECTION_TYPE:
    case USB_TEMP_AI_FILTER_RATE:
    case USB_TEMP_AI_EXCITATION:
    case USB_TEMP_AI_CH_0_TC:
    case USB_TEMP_AI_CH_1_TC:
    case USB_TEMP_AI_CH_0_GAIN:
    case USB_TEMP_AI_CH_1_GAIN:
    ...
    case USB_TEMP_AI_CH_1_VOLT_CONN:
      ...
      break;
    case USB_TEMP_AI_VREF:
    case USB_TEMP_AI_I_value_0:
    case USB_TEMP_AI_I_value_1:
    case USB_TEMP_AI_I_value_2:
    case USB_TEMP_AI_V_value_0:
    case USB_TEMP_AI_V_value_1:
    case USB_TEMP_AI_V_value_2:
    case USB_TEMP_AI_CH_0_COEF_0:
    case USB_TEMP_AI_CH_1_COEF_0:
    case USB_TEMP_AI_CH_0_COEF_1:
    case USB_TEMP_AI_CH_1_COEF_1:
    case USB_TEMP_AI_CH_0_COEF_2:
    case USB_TEMP_AI_CH_1_COEF_2:
    case USB_TEMP_AI_CH_0_COEF_3:
    case USB_TEMP_AI_CH_1_COEF_3:
      setItemFloat.reportID = SET_ITEM;
      setItemFloat.item = item;
      setItemFloat.subitem = subitem;
      memcpy(setItemFloat.value, &fValue, 4);
...
void usbCalibrate_USBTC_AI(hid_device *hid, uint8_t type)
{
  ...
  */
  ...
  calibrate.type = type;
  calibrate.path = USB_TEMP_AI_CHAN_HI_PATH;
...
void usbConfigAlarm_USBTC_AI(hid_device *hid, uint8_t number, uint8_t in_options, uint8_t out_options, float value_1, float value_2)
{
  ...
  */
  ...
  configAlarm.reportID = USB_TEMP_AI_CONFIG_ALARM;
...
void usbGetAlarmConfig_USBTC_AI(hid_device *hid, uint8_t number, uint8_t *in_options, uint8_t *out_options, float *value_1, float *value_2)
{
  ...
  arg.reportID = USB_TEMP_AI_GET_ALARM_CONFIG;
  arg.number = number;
  alarmConfig.reportID = USB_TEMP_AI_GET_ALARM_CONFIG;
