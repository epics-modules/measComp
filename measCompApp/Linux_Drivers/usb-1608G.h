...
#define USB1608G_DIFFERENTIAL       1
#define USB1608G_CALIBRATION        3
#define USB1608G_LAST_CHANNEL       (0x80)
#define USB1608G_PACKET_SIZE        512       // max bulk transfer size in bytes
#define USB1608G_AIN_SCAN_BURST     0x1       // 1 = burst mode   0 = normal
#define USB1608G_AIN_SCAN_TRIGGER   0x8       // 1 = use trigger
#define USB1608G_AIN_SCAN_RETRIGGER 0x40      // 1 = retrigger mode, 0 = normal trigger
  
/* Analog Output Scan Options */
#define USB1608G_AO_CHAN0       0x1   // Include Channel 0 in output scan
#define USB1608G_AO_CHAN1       0x2   // Include Channel 1 in output scan
#define USB1608G_AO_TRIG        0x10  // Use Trigger
#define USB1608G_AO_RETRIG_MODE 0x20  // Retrigger Mode
  
/* Ranges */
#define USB1608G_BP_10V 0x0      // +/- 10 V
#define USB1608G_BP_5V  0x1      // +/- 5V
#define USB1608G_BP_2V  0x2      // +/- 2V
