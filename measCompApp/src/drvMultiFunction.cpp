...
printf("MultiFunction::MultiFunction ulAIGetInfo for AI_INFO_NUM_CHANS_BY_TYPE, AI_VOLTAGE returned status=%d infoValue=%lld\n", status, infoValue);
    numAnalogIn_ = infoValue;
    status = ulAOGetInfo(daqDeviceHandle_, AO_INFO_NUM_CHANS, 0, &infoValue);
printf("MultiFunction::MultiFunction ulAIGetInfo for AO_INFO_NUM_CHANS_BY_TYPE, 0 returned status=%d infoValue=%lld\n", status, infoValue);
